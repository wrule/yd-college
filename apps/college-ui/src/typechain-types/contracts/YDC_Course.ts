...
export type ST_YDC_Course_URIStruct = {
...
export type ST_YDC_Course_URIStructOutput = [
  courseId: bigint,
  courseTypeId: bigint,
  name: string,
  summary: string,
...
export interface YDC_CourseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
...
export interface YDC_Course extends BaseContract {
  connect(runner?: ContractRunner | null): YDC_Course;
  waitForDeployment(): Promise<this>;

  interface: YDC_CourseInterface;
  ...
  getMyCourses: TypedContractMethod<
    [],
    [ST_YDC_Course_URIStructOutput[]],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "getMyCourses"
  ): TypedContractMethod<[], [ST_YDC_Course_URIStructOutput[]], "view">;
  getFunction(
